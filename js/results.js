$(document).ready(() => {
    ...
    function initialize() {
        ...
        set_bar_and_percent("equality", "market", Math.round(equality))
        set_bar_and_percent("liberty", "authority", Math.round(liberty))
        set_bar_and_percent("progress", "tradition", Math.round(progress))
        set_bar_and_percent("ecology", "production", Math.round(ecology))
